    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          // lesson-01 → Mindset
          {
            from: "/docs/pmi-acp/module-01/lesson-01",
            to: "/docs/pmi-acp/domains/domain-mindset",
          },
          {
            from: "/pmi-acp/module-01/lesson-01",
            to: "/docs/pmi-acp/domains/domain-mindset",
          },

          // lesson-02 → Delivery
          {
            from: "/docs/pmi-acp/module-01/lesson-02",
            to: "/docs/pmi-acp/domains/domain-delivery",
          },
          {
            from: "/pmi-acp/module-01/lesson-02",
            to: "/docs/pmi-acp/domains/domain-delivery",
          },
        ],
      },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          to: "/docs/pmi-acp/blueprint-2025",
        ...
        { type: "localeDropdown", position: "right" },
        {
          ...
          items: [
            ...
            {
              href: "https://github.com/lehoangduy1911/pmi-acp-site",
              label: "GitHub",
            },
          ],
        },
